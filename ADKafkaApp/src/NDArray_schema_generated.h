...
inline const char **EnumNamesDType() {
  static const char *names[] = {"int8",     "uint8",  "int16",   "uint16",
...
public:
  ...
  epicsTimeStamp(const epicsTimeStamp &_o) {
    memcpy(this, &_o, sizeof(epicsTimeStamp));
  }
...
struct NDAttributeBuilder {
  ...
  void add_dataType(DType dataType) {
    fbb_.AddElement<int8_t>(NDAttribute::VT_DATATYPE,
                            static_cast<int8_t>(dataType), 0);
  }
...
inline flatbuffers::Offset<NDAttribute> CreateNDAttributeDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *pName = nullptr,
  ...
  return FB_Tables::CreateNDAttribute(
      _fbb, pName ? _fbb.CreateString(pName) : 0,
...
struct NDArray FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<NDAttribute>> *
...
struct NDArrayBuilder {
  ...
  void add_dataType(DType dataType) {
    fbb_.AddElement<int8_t>(NDArray::VT_DATATYPE, static_cast<int8_t>(dataType),
                            0);
  }
  void add_pData(flatbuffers::Offset<flatbuffers::Vector<uint8_t>> pData) {
  ...
  void add_pAttributeList(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<NDAttribute>>>
          pAttributeList) {
...
inline flatbuffers::Offset<NDArray> CreateNDArray(
    ...
    double timeStamp = 0.0, const epicsTimeStamp *epicsTS = 0,
...
inline flatbuffers::Offset<NDArray> CreateNDArrayDirect(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t id = 0,
    double timeStamp = 0.0, const epicsTimeStamp *epicsTS = 0,
    const std::vector<uint64_t> *dims = nullptr, DType dataType = DType_int8,
    const std::vector<uint8_t> *pData = nullptr,
    const std::vector<flatbuffers::Offset<NDAttribute>> *pAttributeList =
        nullptr) {
  return FB_Tables::CreateNDArray(
      _fbb, id, timeStamp, epicsTS,
      dims ? _fbb.CreateVector<uint64_t>(*dims) : 0, dataType,
      pData ? _fbb.CreateVector<uint8_t>(*pData) : 0,
      pAttributeList
          ? _fbb.CreateVector<flatbuffers::Offset<NDAttribute>>(*pAttributeList)
          : 0);
}
