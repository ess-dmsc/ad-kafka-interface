...
KafkaDriverConfigure("$(KFKDET_PORT)", 10, 0, 0, 0, "cs04r-sc-vserv-197:9092", "test_topic")
dbLoadRecords("ADKafka.template", "P=$(PREFIX):, R=KFK_DRVR:, PORT=$(KFKDET_PORT), ADDR=0, TIMEOUT=1")

KafkaPluginConfigure("$(K_PORT)", 3, 1, "$(KFKDET_PORT)", 0, -1, "cs04r-sc-vserv-197:9092", "sim_data_topic")
