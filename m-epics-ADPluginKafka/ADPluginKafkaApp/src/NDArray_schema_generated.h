...
MANUALLY_ALIGNED_STRUCT(4) epicsTimeStamp FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  epicsTimeStamp() {
    memset(this, 0, sizeof(epicsTimeStamp));
  }
...
struct NDAttributeBuilder {
  ...
  NDAttributeBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<NDAttribute> CreateNDAttributeDirect(
  ...
  return FB_Tables::CreateNDAttribute(
      _fbb,
      pName ? _fbb.CreateString(pName) : 0,
      pDescription ? _fbb.CreateString(pDescription) : 0,
      pSource ? _fbb.CreateString(pSource) : 0,
      dataType,
