...
class epicsShareClass KafkaPlugin : public NDPluginDriver {
  public:
     ...
     * @param[in] portName The name of the asyn port driver to be created. Can be used to chain
     * plugins.
     * @param[in] queueSize The number of NDArrays that the input queue for this plugin can hold
     * when NDPluginDriverBlockingCallbacks=0.  Larger queues can decrease the number of
     * dropped arrays, at the expense of more NDArray buffers being allocated from the underlying
